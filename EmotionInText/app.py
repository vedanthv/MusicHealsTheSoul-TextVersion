...
def main():
    ...
    if choice == 'Home':
        st.subheader("Well Crefted songs to Cheer Up your mood")
        ...
        if submit_text:
            ...
            with col1:
                ...
                if(prediction == 'sadness'or prediction == 'anger' or prediction == 'worry'):
                    st.markdown("**You dont look happy today 😔 here are some songs to cheer you up!!**")
                    for i in range(1):
                        random.shuffle(track_ids)
                        embed = '<iframe src="https://open.spotify.com/embed/track/{}" width="300" height="400" frameborder="0" allowtransparency="true" allow="encrypted-media"></iframe>'.format(track_ids[i])

                        st.markdown(embed, unsafe_allow_html=True)        
        
                else:
                    st.write("**Hurray! You seem to be happy today! Enjoy your life:)**")
